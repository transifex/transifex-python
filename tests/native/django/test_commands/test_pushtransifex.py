...
def test_python_parsing_push_exception(mock_find_files, mock_read, mock_push_strings):
    ...
    expected = [
        ...
        SourceString(u'Le canapé', u'désign1,désign2',
                     occurrences=['r1/1.py:6'],),
        SourceString(
            u'Les données', u'opération', developer_comment='comment',
            tags='t1,t2', character_limit=33, occurrences=['r1/1.py:7'],
        ),
        # 2.py
        SourceString(u'Le canapé 2', u'désign1,désign2',
                     occurrences=['r1/dir2/2.py:6'],),
        SourceString(
            u'Les données 2', u'opération', developer_comment='comment',
            tags='t1,t2', character_limit=33, occurrences=['r1/dir2/2.py:7'],
        ),
        # 3.py
        SourceString(u'Le canapé 3', u'désign1,désign2',
                     occurrences=['r1/dir3/3.py:6'],),
        SourceString(
            u'Les données 3', u'opération', developer_comment='comment',
            tags='t1,t2', character_limit=33, occurrences=['r1/dir3/3.py:7'],
        ),
    ]
    compare(expected)
...
def test_template_parsing(mock_find_files, mock_read, mock_push_strings):
    ...
    expected = [
        # 1.html
        SourceString(
            u'<b>Strong</b> {a}', 'c1,c2', tags='t1,t2',
            developer_comment="comment1", character_limit=22,
            occurrences=['r1/dir2/1.html:4'],
        ),
        SourceString(
            u'παράδειγμα {b}', 'c1,c2', tags='t1,t2',
            developer_comment="comment2", character_limit=33,
            occurrences=['r1/dir2/1.html:5'],
        ),

        # 1.txt
        SourceString(
            u'\nThis is a short string\n', 'c1,c2', tags='t1,t2',
            developer_comment="co1", character_limit=22,
            occurrences=['r4/dir5/1.txt:4'],
        ),
        SourceString(
            u'\nThis is not a shorter string\n', 'c1,c2', tags='t1,t2',
            developer_comment="co2", character_limit=33,
            occurrences=['r4/dir5/1.txt:7'],
        ),
    ]
    compare(expected)
